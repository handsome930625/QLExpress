...
public class ForInstructionFactory extends InstructionFactory {
    ...
    public boolean createInstruction(ExpressRunner compile, InstructionSet result,
        ...
        if (conditionNode.getChildren() != null && conditionNode.getChildren().length == 3) {
            ...
            compile.createInstructionSetPrivate(result, forStack, conditionNode.getChildren()[0], false);
        ...
        if (conditionNode.getChildren() != null
            ...
            compile.createInstructionSetPrivate(result, forStack, conditionNode.getChildren()[nodePoint], false);
            // 跳转的位置需要根据后续的指令情况决定
        ...
        // 生成循环体的代码
        compile.createInstructionSetPrivate(result, forStack, node.getChildren()[1], false);
