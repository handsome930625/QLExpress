...
public class OperatorMethod extends OperatorBase {
    private static final long serialVersionUID = 7624605559224707190L;
    ...
    private static Class<?> ArrayClass = (new Object[]{}).getClass();
    ...
    public OperateData executeInner(InstructionSetContext parent, ArraySwap list) throws Exception {
        ...
        if (obj == null) {
            ...
            if (m == null) {
                ...
                s.append("没有找到").append(obj.getClass().getName()).append("的方法：").append(methodName).append("(");
