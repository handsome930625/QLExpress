...
public class KeyWordDefine4Java {
    ...
    public String[] nodeTypeDefines = new String[]{
            ...
            // .ID(express,express) .FUNCTION_NAME(express,express)
            ...
            // EXPRESS_JUDGEANDSET : TODO: review
